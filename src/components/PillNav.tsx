...
const PillNav = ({
  ...
  const toggleMobileMenu = () => {
    ...
    const hamburger: any = hamburgerRef.current;
    const menu: any = mobileMenuRef.current;
  ...
  const isRouterLink = (href: any) => href && !isExternalLink(href);
  ...
  return (
    <div className="pill-nav-container w-full flex justify-center fixed pt-4 left-0 top-0">
